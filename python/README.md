...
```json
{
  ...
  "generatedAt": "2026-09-25T15:16:43.906116",
  "seed": 7,
  "skills": {
    "technical": [
      "Commercial Cooking"
...
- **Grounded QA pairs.** `build_qa_pairs()` turns a profile into
...
- **Eval harness.** `evaluate_dataset()` scores any batch with one quality
